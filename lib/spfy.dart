              ...
              background: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Image.asset("assets/img/99.jpeg")),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Icon(Icons.favorite_border,color: Colors.white12),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Icon(Icons.arrow_circle_down_sharp,color: Colors.white12),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Icon(Icons.more_vert,color: Colors.white12),
                    ),
                    Padding(
